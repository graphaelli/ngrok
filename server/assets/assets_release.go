...
func assets_server_tls_snakeoil_crt() (*asset, error) {
	...
	info := bindata_file_info{name: "assets/server/tls/snakeoil.crt", size: 1809, mode: os.FileMode(420), modTime: time.Unix(1420168417, 0)}
...
func assets_server_tls_snakeoil_key() (*asset, error) {
	...
	info := bindata_file_info{name: "assets/server/tls/snakeoil.key", size: 3243, mode: os.FileMode(420), modTime: time.Unix(1420168417, 0)}
	a := &asset{bytes: bytes, info:  info}
	return a, nil
}
